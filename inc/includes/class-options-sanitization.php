...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'runway' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'runway' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'runway' ),
		'repeat'    => esc_html__( 'Repeat All', 'runway' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'runway' ),
		'top center'    => esc_html__( 'Top Center', 'runway' ),
		'top right'     => esc_html__( 'Top Right', 'runway' ),
		'center left'   => esc_html__( 'Middle Left', 'runway' ),
		'center center' => esc_html__( 'Middle Center', 'runway' ),
		'center right'  => esc_html__( 'Middle Right', 'runway' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'runway' ),
		'bottom center' => esc_html__( 'Bottom Center', 'runway' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'runway')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'runway' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'runway')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'runway' ),
		'italic'      => esc_html__( 'Italic', 'runway' ),
		'bold'        => esc_html__( 'Bold', 'runway' ),
		'bold italic' => esc_html__( 'Bold Italic', 'runway' )
		);
